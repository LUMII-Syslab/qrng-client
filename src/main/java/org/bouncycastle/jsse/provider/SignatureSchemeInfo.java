...
class SignatureSchemeInfo
{
    ...
    private enum All
    {
        ...
        rsa_md5(historical_rsa_md5, "rsa_md5", "MD5withRSA", "RSA"), // comma by SK

        rainbowIclassic(SignatureScheme.oqs_rainbowIclassic, /*"SHA256withRainbowIClassic"*/"SHA256WITHRainbow", "RainbowIClassic---whatever", true) ,// by SK
        sphincsshake256128frobust(SignatureScheme.oqs_sphincsshake256128frobust, /*"SHA256withRainbowIClassic"*/"SPHINCSPLUS", "SPHINCS+"/*"whatever---sphincsshake256128frobust"*/, true, true, -1);// by SK2
