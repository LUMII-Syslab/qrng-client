...
import org.bouncycastle.tls.crypto.impl.jcajce.PQC_KEM;
...
public class TlsUtils
{
    ...
    private static Hashtable createCertSigAlgOIDs()
    {
        ...
        addCertSigAlgOID(h, PQCObjectIdentifiers.oqs_rainbowIclassic, SignatureAndHashAlgorithm.oqs_rainbowIclassic_sha256); // by SK
        addCertSigAlgOID(h, PQCObjectIdentifiers.oqs_sphincsshake256128frobust, SignatureAndHashAlgorithm.oqs_sphincsshake256128frobust_sha256); // by SK2
        // TODO[RFC 8998]
//        addCertSigAlgOID(h, GMObjectIdentifiers.sm2sign_with_sm3, HashAlgorithm.sm3, SignatureAlgorithm.sm2);
    ...
    private static Vector createDefaultSupportedSigAlgs()
    {
        ...
        result.addElement(SignatureAndHashAlgorithm.oqs_rainbowIclassic_sha256); // by SK
        result.addElement(SignatureAndHashAlgorithm.oqs_sphincsshake256128frobust_sha256); // by SK2
...
//            return GMObjectIdentifiers.sm3;
        ...
        Hashtable clientAgreements, Vector clientShares) throws IOException
    {
        ...
        for (int i = 0; i < supportedGroups.length; ++i)
        {
            ...
            else if (NamedGroup.refersToPQC(supportedGroup)) {
                if (!(crypto instanceof JcaTlsCrypto))
                    assert(false);
                agreement = new PQC_KEM((JcaTlsCrypto)crypto, "FrodoKEM-640-AES");
            }
