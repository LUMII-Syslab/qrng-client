...
/**
 * #pqc-tls #injection
 * KemAgreement wraps a Half-KEM and represents it as a BouncyCastle TlsAgreement.
 * The Half-KEM invokes keyGen() at the client, encapsulate() at the server, and decapsulate() at the client.
 * @author Sergejs Kozlovics
 */
public class KemAgreement implements TlsAgreement {
    ...
    public KemAgreement(JcaTlsCrypto crypto, boolean isServer, KEM kem) {
        this.crypto = crypto;
