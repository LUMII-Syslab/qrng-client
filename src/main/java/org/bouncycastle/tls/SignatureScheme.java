...
public class SignatureScheme
{
    ...
    public static final int oqs_rainbowIclassic = 0xFE27; // by SK
    public static final int oqs_p256_rainbowIclassic_with_p256 = 0xFE28; // by SK
    public static final int oqs_sphincsshake256128frobust = 0xfe7a; // by SK
    ...
    public static int getCryptoHashAlgorithm(int signatureScheme)
    {
        ...
        case oqs_rainbowIclassic: // by SK
            return CryptoHashAlgorithm.sha256;
        case oqs_sphincsshake256128frobust: // by SK2???
            return -1; //hash built-in into sphincs! CryptoHashAlgorithm.sha256;
        default:
        {
    ...
    public static boolean isPQC(int signatureScheme) { // by SK

        return
            (signatureScheme==oqs_rainbowIclassic) ||
            (signatureScheme==oqs_p256_rainbowIclassic_with_p256)
                || (signatureScheme==oqs_sphincsshake256128frobust); // by SK3+
    }
}
