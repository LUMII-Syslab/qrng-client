...
//        }
    ...
    public TlsVerifier createVerifier(int signatureScheme) throws IOException
    {
        ...
        // by SK
//        case SignatureScheme.oqs_rainbowIclassic:
//        case SignatureScheme.oqs_p256_rainbowIclassic_with_p256:
        case SignatureScheme.oqs_sphincsshake256128frobust:
        {
            return new PQC_CERT_Verifier(crypto, getPublicKey(), signatureScheme); // by SK3+
        }
