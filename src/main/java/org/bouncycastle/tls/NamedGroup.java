...
public class NamedGroup
{
    ...
    // by SK
    public static final int oqs_p256_frodo640aes = 0x2F00; // 12032
    public static final int oqs_frodo640aes = 0x0200; // 512
    public static final int oqs_frodo640shake = 0x0201;
    ...
    public static boolean canBeNegotiated(int namedGroup, ProtocolVersion version)
    {
        ...
        {
            if ((namedGroup==12032) || (namedGroup==512) || (namedGroup==513))
                return true; // by SK
    ...
    public static boolean refersToPQC(int namedGroup) // by SK
    {
        return namedGroup==oqs_p256_frodo640aes
                || namedGroup==oqs_frodo640aes
                || namedGroup==oqs_frodo640shake;
    }
}
