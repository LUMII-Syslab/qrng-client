...
public class SPHINCSPlusSigner
    implements MessageSigner, TlsSigner // TlsSigner by SK client cert

{
    ...
    public void initForSigning(SPHINCSPlusPrivateKeyParameters params)
    {
        privKey = params;
    }
...
//        # Output: SPHINCS+ signature SIG
    ...
    public class MyStreamSigner implements TlsStreamSigner {
        ...
        public byte[] getSignature() throws IOException {
            return SPHINCSPlusSigner.this.generateRawSignature(algorithm, os.toByteArray());
        }
    }
}
