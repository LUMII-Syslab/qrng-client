...
public class Frodo
{
        ...
        extends AsymmetricAlgorithmProvider
    {
        ...
        public void configure(ConfigurableProvider provider)
        {
            ...
            provider.addAlgorithm("Alg.Alias.KeyFactory." + "p256_frodo640shake", "FRODO"); // by SK
            provider.addAlgorithm("Alg.Alias.KeyGenerator." + "p256_frodo640shake", "FRODO"); // by SK
            provider.addAlgorithm("Alg.Alias.KeyPairGenerator." + "p256_frodo640shake", "FRODO"); // by SK
